...
ActiveRecord::Schema.define(version: 20170529111496) do
  ...
  add_index "spree_option_types", ["vendor_id"], name: "index_spree_option_types_on_vendor_id"
  ...
  add_index "spree_products", ["vendor_id"], name: "index_spree_products_on_vendor_id"
  ...
  add_index "spree_properties", ["vendor_id"], name: "index_spree_properties_on_vendor_id"
  ...
  add_index "spree_shipping_methods", ["vendor_id"], name: "index_spree_shipping_methods_on_vendor_id"
  ...
  add_index "spree_stock_locations", ["vendor_id"], name: "index_spree_stock_locations_on_vendor_id"
  ...
  add_index "spree_variants", ["vendor_id"], name: "index_spree_variants_on_vendor_id"
  ...
  add_index "spree_vendor_users", ["user_id"], name: "index_spree_vendor_users_on_user_id"
  add_index "spree_vendor_users", ["vendor_id", "user_id"], name: "index_spree_vendor_users_on_vendor_id_and_user_id", unique: true
  add_index "spree_vendor_users", ["vendor_id"], name: "index_spree_vendor_users_on_vendor_id"
  ...
  add_index "spree_vendors", ["deleted_at"], name: "index_spree_vendors_on_deleted_at"
  add_index "spree_vendors", ["name"], name: "index_spree_vendors_on_name", unique: true
  add_index "spree_vendors", ["state"], name: "index_spree_vendors_on_state"
